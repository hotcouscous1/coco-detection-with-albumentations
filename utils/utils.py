...
def category_filter(
    ...
    """
    It excludes unused categories, and matches remainders to new categories in dictionary.
    It costs only O(1).
    """
...
def fill_empty_category(
    ...
    """
    Before the evaluation, the missing categories must be put back on place.
    """
...
def make_mini_batch(
    ...
    """argument for collate_fn of torch.utils.data.DataLoader"""
